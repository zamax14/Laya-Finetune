"""La tarea: clasificar tickets de soporte de TI con tres preguntas tipadas, y los 20 tickets de prueba.

Es la misma definición que el benchmark de Pondera (github.com/zamax14/Laya-Showcase): categoría (choice),
prioridad (score) y bloqueo (noul). Los 20 tickets de TICKETS, escritos a mano, solo sirven para medir; nunca
...
# La tercera pregunta: con ella las tres clases de pregunta (choice, score, noul) tienen referencia.
QUESTIONS = {**QUESTIONS, "bloqueo": {"type": "noul", "instructions":
...
# Semáforo sobre la confianza de la categoría: cuánta atención humana necesita la asignación.
...
# ninguna de las dos llega al modelo. Cada ticket está escrito como lo escribiría quien
